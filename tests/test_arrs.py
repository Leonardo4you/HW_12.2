...
class TestArrs:
    ...
    def test_slice(self, data):
        ...
        assert arrs.my_slice(data) == [1, 2, 3]
        assert arrs.my_slice(data, 0, 5) == [1, 2, 3]
        assert arrs.my_slice(data, 2, 1) == []
        assert arrs.my_slice(data, -2) == [2, 3]
        assert arrs.my_slice(data, 0, -1) == [1, 2]
